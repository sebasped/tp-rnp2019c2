...
class CNN(torch.nn.Module):
    def __init__(self, in_chann=1, out_classes=2): 
        super().__init__()
        self.conv1 = torch.nn.Conv1d(in_chann, out_channels=5, kernel_size=3, stride=1, padding=1)
#        self.c2 = torch.nn.Conv2d(5, 25, 3, 1, 1)
        self.mpool1 = torch.nn.MaxPool1d(50)
        self.H = 5*150//5
#        self.L1 = torch.nn.Linear(self.H, 512)
#        self.L2 = torch.nn.Linear(512,out_classes)
        self.Linear1 = torch.nn.Linear( self.H, out_classes)
